...
public class UI extends JFrame implements OnReceive{
	...
	public static boolean sendButton(boolean isClicked) {
		String t = UI.send.getText();
		if(isClicked) {
			UI.msg.setText("ON");
			send.setText("Send");
			return true;
